...
class Payment{
    ...
    private $ApiKey="key_rWzoLqyLGRleRONzRIn2SxI";
    private $ApiVersion="2.0.0";

    private $UserDB="root";
    private $PassDB="";
    private $ServerDB="localhost";
    private $DataBaseDB="conekta";
    ...
    public function Save(){
        ...
        $statement = $link->prepare("INSERT INTO conekta (nombre,numero,concepto,monto,email)
            VALUES (:name,:number_card,:description,:total,:email)");
